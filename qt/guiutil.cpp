...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("manxcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("manxcoin://"))
    {
        uri.replace(0, 11, "manxcoin:");
    }
...
{
    return GetAutostartDir() / "manxcoin.desktop";
}
    ...
    QMessageBox(parent)
{
    header = tr("Litecoin-Qt") + " " + tr("version") + " " +
        ...
        tr("Usage:") + "\n" +
        "  manxcoin-qt [" + tr("command-line options") + "]                     " + "\n";
