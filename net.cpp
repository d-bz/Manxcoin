...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Manxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"manxcointools.com", "dnsseed.manxcointools.com"},
    {"manxcoinpool.org", "dnsseed.manxcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"manxcointools.com", "testnet-seed.manxcointools.com"},
    ...
    loop
    {
        ...
        if (addrman.size()==0 && (GetTime() - nStart > 60) && !fTestNet)
        {
            ...
            for (unsigned int i = 0; i < ARRAYLEN(pnSeed); i++)
            {
             ...
             //addrman.Add(vAdd, CNetAddr("82.165.44.132"));
