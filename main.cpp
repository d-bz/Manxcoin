...
uint256 hashGenesisBlock("0xf8fb4d279ebb0da7f873c4ae80a8972321c11cc7676c5be04eeea693c266c57b");
...
const string strMessageMagic = "Manxcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Guardian 05/Feb/2014 The Garah Is The Place To Be";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1397220014;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087709101;
        ...
        assert(block.hashMerkleRoot == uint256("0x953cdb586e5d8509c0ba7c80dd4f27055d5c3bd9f8155993adccd47c84de3f70"));
  /*      
